...
export const TooltipContent = <T extends ValidComponent = "button">(
  ...
  return (
    <TooltipPrimitive.Content
      ...
      class={cx(
        "bg-popover text-popover-foreground border border-border-subtle shadow-[var(--shadow-sm)] animate-in fade-in-0 zoom-in-95 data-[closed]:animate-out data-[closed]:fade-out-0 data-[closed]:zoom-out-95 z-50 w-fit origin-(--kb-tooltip-content-transform-origin) rounded-md px-2.5 py-1 text-[11px] text-balance",
